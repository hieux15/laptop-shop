          ...
          <div className="lg:col-span-5">
            <div className="bg-white p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl shadow-sm border border-gray-100">
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <button className="w-full bg-blue-600 text-white h-12 sm:h-14 rounded-lg sm:rounded-xl font-bold text-base sm:text-lg hover:bg-blue-700 transition shadow-lg shadow-blue-200">
                  MUA NGAY
                </button>
              </div>
            </div>
