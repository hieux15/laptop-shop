      ...
      <div className="bg-gray-50 min-h-screen pb-20">
        ...
        <div className="bg-gray-50 mb-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
            <div className="flex items-center text-xs sm:text-sm text-gray-500">
              <Link href="/" className="inline-flex items-center gap-1.5 hover:text-blue-600 transition-colors">
                <Home size={16} />
                <span>Trang chủ</span>
              </Link>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 text-center">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Đơn hàng thành công!</h1>
            <p className="text-lg text-gray-600 mb-8">
              Cảm ơn bạn đã mua hàng. Đơn hàng của bạn đã được ghi nhận và sẽ được xử lý sớm.
            </p>
            <div className="bg-blue-50 rounded-xl p-6 mb-8 text-left">
              <p className="text-sm text-gray-600 mb-2">Mã đơn hàng:</p>
              <p className="text-lg font-bold text-blue-600 mb-4">ORD-{Date.now()}</p>
            ...
            <p className="text-gray-600 mb-8">
              Email xác nhận đã được gửi đến <span className="font-semibold">{formData.email}</span>
            </p>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8">
                ...
                <div className="space-y-3">
                  <label className="flex items-center p-4 border-2 border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 transition"
                    style={{borderColor: formData.paymentMethod === 'cod' ? '#2563eb' : '#d1d5db'}}>
                    <input
                      type="radio"
                      name="paymentMethod"
                      value="cod"
                  ...
                  <label className="flex items-center p-4 border-2 border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 transition"
                    style={{borderColor: formData.paymentMethod === 'card' ? '#2563eb' : '#d1d5db'}}>
                    <input
                      type="radio"
                      name="paymentMethod"
                      value="card"
                      ...
                      className="w-4 h-4 text-blue-600"
                    />
                    <span className="ml-3 font-medium text-gray-900">Thẻ tín dụng / Ghi nợ</span>
                  </label>

                  <label className="flex items-center p-4 border-2 border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 transition"
                    style={{borderColor: formData.paymentMethod === 'bank' ? '#2563eb' : '#d1d5db'}}>
                    <input
                      type="radio"
                      name="paymentMethod"
                      value="bank"
